...
<div class="uk-form-row">
  ...
  <?php
  echo CHtml::radioButton('sms_provider',
$provider_selected=="libonet"?true:false
,array(
'class'=>"icheck",
'value'=>"libonet"
));
...
<div class="uk-form-row">
  ...
  <?php 
  echo CHtml::textField('libonet_username',
  Yii::app()->functions->getOptionAdmin('libonet_username')
  ,array(
    'class'=>"uk-form-width-large"    
  ))
  ?>
...
<div class="uk-form-row">
  ...
  <?php 
  echo CHtml::passwordField('libonet_password',
  Yii::app()->functions->getOptionAdmin('libonet_password')
  ,array(
    'class'=>"uk-form-width-large"    
  ))
  ?>
...
<div class="uk-form-row">
  ...
  <?php 
  echo CHtml::textField('libonet_sender',
  Yii::app()->functions->getOptionAdmin('libonet_sender')
  ,array(
    'class'=>"uk-form-width-large"    
  ))
  ?>
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Use CURL")?>?</label>
  <?php 
  echo CHtml::checkBox('libonet_use_curl',
  Yii::app()->functions->getOptionAdmin('libonet_use_curl')==1?true:false
  ,array(
    'value'=>1,
    'class'=>"icheck"
  ))
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Use Unicode")?>?</label>
  <?php 
  echo CHtml::checkBox('libonet_use_unicode',
  Yii::app()->functions->getOptionAdmin('libonet_use_unicode')==1?true:false
  ,array(
    'value'=>1,
    'class'=>"icheck"
  ))
